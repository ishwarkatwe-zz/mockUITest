...
var galaxy = d3.layout.galaxy()
    .size([width, height])
    .spread(4)
    .initialAngle(1.58) // radians from down
    .value(function (d) {
        return d.size;
    });
        ...
        function (error, txtdata) {
            ...
            node.append("circle")
                ...
                .style("stroke", function (d) {
                    ...
                    div.transition()
                        .duration(200)
                        .style("opacity", .9);
                    div.html('<div>' + d.name + ' - <span>' + format(d.value) + '</span></div>')
            ...
            node.append("text")
                ...
                .text(function (d) {
                    ...
                    if (d && d['parent'] && d['parent']['name'] == 'University of Cambridge') {
                        return d.name;
                    }
